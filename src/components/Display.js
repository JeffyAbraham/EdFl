  ...
  return (
    <div>
      <div style={{ padding: "20px" }}>
        <h5 style={{ paddingBottom: "20px", fontSize: "20px" }}>
          Temp Difference:{Math.floor(weatherDetails.temp - weatherDetails.per)}
          °C
        </h5>
        <p style={{ fontSize: "23px", fontWeight: "600", lineHeight: "1.334" }}>
